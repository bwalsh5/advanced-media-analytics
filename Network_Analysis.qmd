...
## Density, Reciprocity & Modularity
...
write.csv(mentions_net, "chatgpt_mention.csv", row.names=FALSE)
...
![Mention Network of Twitter Conversations on ChatGPT](images/GPT_mention_nework.png)
...
write.csv(message_net, "chatgpt_message.csv", row.names=FALSE)
...
![Message Network of Twitter Conversations on ChatGPT](images/GPT_message_nework.png)
...
write.csv(UserSource_net, "UserSource_net.csv", row.names=FALSE)
...
![User-Source Network of Twitter Conversations on ChatGPT](images/GPT_user-source_nework.png)
...
write.csv(word_pairs_hash, "hash.csv", row.names=FALSE)
...
![Co-Hashtag Network of Twitter Conversations on ChatGPT](images/GPT_hash.png)
...
write.csv(UserHash_net, "UserHash_net.csv", row.names=FALSE)
...
![Hashtag-User Network of Twitter Conversations on ChatGPT: 1](images/GPT_userhash_1.png)
...
![Hashtag-User Network of Twitter Conversations on ChatGPT: 2](images/GPT_userhash_2.png)
...
write.csv(HashMe_net, "HashMe_net.csv", row.names=FALSE)
...
![Hashtag-Mention Network of Twitter Conversations on ChatGPT](images/GPT_mentionhash.png)
...
1.  Utilize your Twitter APIs to collect up to 5000 of the most recent tweets containing a hashtag of your choice.

2.  Use R to create a Twitter network. This could include networks such as a mention network, message network, user-source network, co-hashtag network, hashtag-user network, or hashtag-mention network.

3.  Import the Twitter network data into Gephi to create network visualizations.
