...
From the above statistics and graph, you can see the significant interaction effect between gender and influencer type for predicting impacts. Male micro influencers had a little bit higher impacts than female micro influencers. But for other types of influencers, such as megas, males had lower impacts than females.
...
![Sample regression output](images/6.png)
...
![Interaction effects visualization](images/7.png)
